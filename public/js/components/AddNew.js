                        ...
                        <form onSubmit={this.onSubmit}>
                                    ...
                                    <div className="form-group">
                                        <div className="radio-group">
                                            <input
                                                type="radio"
                                                id="rbMale"
                                                className="Person rbGender"
                                                onChange={this.handleGenderChange}
                                                value="m"
                                                name="gender"
                                            />
                                            <label htmlFor="rbMale" className="rbGenderLabel">
                                                Male
                                            </label>
                                            <input
                                                type="radio"
                                                ...
                                                name="gender"
                                            />
                                            <label htmlFor="rbFemale" className="rbGenderLabel">
                                                Female
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <Mutation
                                ...
                                variables={{
                                    input: {
                                        ...this.state.Lead,
                                        [this.state.typeOfLead]: { ...this.state[this.state.typeOfLead] },
                                    },
                                }}
                            >
                                {addLeadMutation => {
                                    return (
                                        <div className="form-group">
                                            <button
                                                type="button"
                                                onClick={() => {
                                                    addLeadMutation(), this.restartState()
                                                }}
